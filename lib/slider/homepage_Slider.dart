...
class HomePage_SliderButton extends StatefulWidget {
  ...
  @override
  _HomePage_SliderButtonState createState() => _HomePage_SliderButtonState();
}

class _HomePage_SliderButtonState extends State<HomePage_SliderButton> {
  late bool flag;
